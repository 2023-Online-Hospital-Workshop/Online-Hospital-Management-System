        ...
        <div id="info">
          ...
          <div class="info-container" v-if="getIcon !== 'edit'">
            <va-input
              ...
              readonly
              class="info-input"
              placeholder="请输入7位数的学号"
              background="rgb(255,255,255)"
              ><template #prepend> 学号： </template></va-input
            >
            <va-input
              v-model.lazy="name"
              placeholder="请输入你的姓名"
            ...
            <va-input
              ...
              :background="input_bg"
              :readonly="readonly"
              ><template #prepend> 学院： </template></va-input
            >
            <va-input
              v-model="counselor"
              stacked="false"
              ...
              :background="input_bg"
              :readonly="readonly"
              ><template #prepend> 导员： </template></va-input
            >
          </div>
...
export default {
  ...
  methods: {
    ...
    getName() {
      ...
      axios
        .get("http://124.223.143.21:4999/Personinfo?", {
          params: {
    ...
    putServer() {
      const url = "http://124.223.143.21:4999/Personinfo/update";
      const data = {
        patientId: this.studentId,
        name: this.name,
