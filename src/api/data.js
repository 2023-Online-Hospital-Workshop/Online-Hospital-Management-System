...
export const getQualificationCard = (uid,access_token) => {
    return axios.request({
...
export const putDoctorDisable = (uid, myobj,access_token) => {
    return axios.request({
        url: '/API/Doctor/',
        method: 'put',
        params: { id: uid },
...
export const getNurseCard = (uid,access_token) => {
    return axios.request({
...
export const getDoctorCard = (uid,access_token) => {
    return axios.request({
        url: '/API/Doctor/id',
        method: 'get',
        params: { doctorid: uid },
...
export const putQualification = (obj,access_token) => {
    return axios.request({
        url: '/API/Qualifacation',
        method: 'put',
        data: obj,
