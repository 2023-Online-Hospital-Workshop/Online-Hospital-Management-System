...
<el-form ref="baseForm" :model="baseForm" :rules="rules" auto-complete="on">
  <div class="views">
    <el-row :gutter="1">
      ...
      <el-col :span="5">
        <el-select v-model="options[this.selectedIndex].name"  placeholder="请选择老人">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      Axios.all([this.getAllElder()])
        .then(Axios.spread((resElder) => {
          console.log("后端请求成功!");
          //所有老人
