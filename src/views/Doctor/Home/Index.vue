    ...
    <el-row gutter="30" v-loading.fullscreen.lock="fullscreenLoading">
        <el-col :span="10">
                ...
                <el-row gutter="20">
                    <el-col :span="6">
                        <div>
                            ...
                            <el-button size="small" @click="gotoEvaluation">查看评价</el-button>
                            </el-badge>
                        </div>                           
                    </el-col>     
                    <el-col :span="6">
                        <div>
                            <el-badge :value="new_value" class="item">
                            <el-button size="small" @click="$router.replace('/doctor/medicalOrderApply')">服务受理</el-button>
                            </el-badge>
                        </div>                           
                    </el-col>  
                    <el-col :span="6">
                        <div>
                            <el-badge :value="new_value" class="item">
                            <el-button size="small" @click="$router.replace('/doctor/clientManagement')">服务记录</el-button>
                            </el-badge>
                        </div>                           
                    </el-col>
                    <el-col :span="6">
            ...
            <el-card class="box_card_show" shadow="hover" >
                ...
                <div class="text item">
                    <p>各页面功能介绍</p>
                    <p>服务申请受理：基于老人的服务申请分配医生</p>
                    <p>投 诉 管 理：审核并处理用户提交的投诉单</p>
                    <p>健康报告管理：查看老人的健康报告并进行管理</p>
                    <p>查看服务评价：查看老人对已完成的服务评价</p>
                    <p>申请人员归档：管理服务进度和历史人员记录</p>
                </div>
            </el-card>
        </el-col>
