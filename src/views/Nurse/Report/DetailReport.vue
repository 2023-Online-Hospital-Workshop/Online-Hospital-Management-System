...
export default {
    ...
    onSubmit () {
      ...
      if (this.form.PUNITIVEMEASURE != '0') {
        ...
        if (this.getRole(this.form.DEFENDANTID) == "医生") {
          ...
          let doctorCard = {};
          //先获取医生原本信息
          getDoctorCard(uid,this.access_token)
            .then((res) => {
              ...
              console.log("doctorCard",doctorCard);

              //PUT修改后端数据，完成封号
              putDoctorDisable(uid, doctorCard,this.access_token)
                .then((res) => {
  ...
  mounted: function () {
    ...
    console.log("这是传入举报单的转换数据",this.form);
