  ...
  <div class="views">
    ...
    >
      ...
      <el-form-item align=center>
        ...
        <el-button align="center" @click="Cancel()">取消</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
    ...
    getPhoto (id, title) {
      axios
        .request({
          ...
          responseType: "blob",
          url: "/API/file/photo/qualification/" + 'qualification'+ "/png",
          method: "get",
          headers: {
    ...
    get_jpg (id, title) {
      axios
        .request({
          ...
          // 需要在main.js中注释掉对mock的引用才能够正常生效
          responseType: "blob",
          url: "/API/file/photo/qualification/" + 'qualification' + "/jpg",
          method: "get",
          headers: {
            TokenValue: this.access_token,
          }
    ...
    get_jpeg (id, title) {
      axios
        .request({
          ...
          // 需要在main.js中注释掉对mock的引用才能够正常生效
          responseType: "blob",
          url: "/API/file/photo/qualification/" + 'qualification' + "/jpeg",
          method: "get",
          headers: {
            TokenValue: this.access_token,
          }
    ...
    get_gif (id, title) {
      axios
        .request({
          ...
          // 需要在main.js中注释掉对mock的引用才能够正常生效
          responseType: "blob",
          url: "/API/file/photo/qualification/" + 'qualification' + "/gif",
          method: "get",
          headers: {
            TokenValue: this.access_token,
          }
