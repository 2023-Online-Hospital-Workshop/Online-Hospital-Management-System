...
import CallService from '../views/Client/CallService.vue'
...
import CareService from '../views/Admin/Carer/CareService.vue'
import CarerQualify from '../views/Admin/Carer/CarerQualify.vue'
import CareCall from '../views/Admin/Carer/CareCall.vue'
...
import AdminDoctorUserInfor from '../views/Admin/User/DoctorUserInfor.vue'
import AdminNurseUserInfor from '../views/Admin/User/NurseUserInfor.vue'
//管理员的个人信息模块
...
import NurseReportHandle from '../views/Nurse/Report/ReportHandle.vue'
import NurseDetailReport from '../views/Nurse/Report/DetailReport.vue'
import NurseSearch from '../views/Nurse/Info/NurseSearch.vue'
import NurseUserInfo from '../views/Nurse/Info/NurseUserInfo.vue'
...
import NurseCarerStep1 from '../views/Nurse/Nurser/CarerStep1.vue'
import NurseCarerStep2 from '../views/Nurse/Nurser/CarerStep2.vue'
import NurseCarerStep3 from '../views/Nurse/Nurser/CarerStep3.vue'
// import NurserHistoryService from '../views/Nurse/Nurser/NurserHistoryService.vue'
import NurseAdminSearch from '../views/Nurse/Message/Search.vue'
import NurseAdminInfo from '../views/Nurse/Message/UserInfo.vue'
...
import ReportHandle from '../views/Doctor/Report/ReportHandle.vue'
...
import AdminHistoryDisease from '../views/Doctor/Home/HistoryDisease.vue'
        ...
        children: [
            ...
            //管理员路由
            {
                ...
                children: [
                    ...
                    {
                        path: 'doctorInfor',
                        name: 'AdminDoctorUserInfor',
                        component: AdminDoctorUserInfor,
                        meta: {
                            needAuth: true,
                            // title: '',
                        }
                    ...
                    {
                        path: 'nurseInfor',
                        name: 'AdminNurseUserInfor',
                        component: AdminNurseUserInfor,
                        meta: {
                            needAuth: true,
                            // title: '',
                        }
                            ...
                            children:
                                [
                                    ...
                                    },
                                    {
                                        ...
                                        component: NurseReportHandle,
                                        meta: {
                                            needAuth: true,
                                        }
                                    },
                                    {
                                        path: 'nurseDetailReport',
                                        name: 'NurseDetailReport',
                                        component: NurseDetailReport,
                                        meta: {
                                            needAuth: true,
                                        }
                                    },
                                    ...
                                    {
                                        path: 'nurseCarerStep1',
                                        name: 'NurseCarerStep1',
                                        component: NurseCarerStep1,
                                        meta: {
                                            needAuth: true,
                                            // title: '',
                                        }
                                    ...
                                    {
                                        path: 'nurseCarerStep2',
                                        name: 'NurseCarerStep2',
                                        component: NurseCarerStep2,
                                        meta: {
                                            needAuth: true,
                                            // title: '',
                                        }
                                    ...
                                    {
                                        path: 'nurseCarerStep3',
                                        name: 'NurseCarerStep3',
                                        component: NurseCarerStep3,
                                        meta: {
                                            needAuth: true,
                                            // title: '',
                                        }
    ...
    if (1) {
        ...
        if (token == null) {
            ...
            if ((role == "0" && (to.fullPath == '/client' || to.fullPath.includes('/client/') || to.fullPath.includes('/clientOrderFrame'))) ||
                (role == "1" && (to.fullPath == '/nurse' || to.fullPath.includes('/nurse/')|| to.fullPath.includes('carerStep')|| to.fullPath.includes('detailReport'))) ||
                (role == "2" && (to.fullPath == '/doctor' || to.fullPath.includes('/doctor/')|| to.fullPath.includes('carerStep')|| to.fullPath.includes('detailReport'))) ||
                (role == "3" && (to.fullPath == '/admin' || to.fullPath.includes('/admin/')|| to.fullPath.includes('/placeCareOrder')))) {
                //不要进无用的根路由
                if (from.name == 'Main') {
